...
Thực hiện tải file File zip plugin theo đường dẫn : [https://downloads.wordpress.org/plugin/{plugin-slug}.{version](https://downloads.wordpress.org/plugin/%7Bplugin-slug%7D.%7Bversion)}.zip. 
